...
function non_Zero_Digits(num: number): number {
...
console.log(non_Zero_Digits(4056));// Output: 120  // 4 * 5 * 6 = 120
console.log(non_Zero_Digits(1002));// Output: 2  // 1 * 2 = 2
...
function largest_And_Smallest(num1: number): number {

    let largest_Digits = -Infinity;
    let smallest_Digits = Infinity;
...
console.log(largest_And_Smallest(7593));// Output: 6  // 9 - 3 = 6
console.log(largest_And_Smallest(12345));// Output: 4  // 5 - 1 = 4